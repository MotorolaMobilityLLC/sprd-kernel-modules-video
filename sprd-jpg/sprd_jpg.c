...
static const struct sprd_jpg_cfg_data qogirn6lite_jpg_data = {
	.version = QOGIRN6L,
	.max_freq_level = 5,
	.qos_reg_offset = 0x30
};
...
static const struct of_device_id of_match_table_jpg[] = {
	...
	{.compatible = "sprd,qogirn6lite-jpg", .data = &qogirn6lite_jpg_data},
	{},
};
